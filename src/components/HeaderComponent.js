...
import { Navbar, NavbarBrand, Jumbotron, Nav, NavbarToggler, Collapse, NavItem, Modal, Button, ModalBody, ModalHeader,
...
class Header extends Component {
  ...
  constructor(props) {
    ...
    if(this) this.handleLogin = this.handleLogin.bind(this);
  }
